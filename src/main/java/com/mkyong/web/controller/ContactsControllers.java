...
import com.mkyong.users.dao.ContactsDAO;
import com.mkyong.users.model.Contact;
import com.mkyong.users.model.ContactFormValidator;
...
public class ContactsControllers
{
	...
	*/
	...
	public ModelAndView passValue()
	{
		ModelAndView mav = new ModelAndView("passValue");
		return mav;
	}
